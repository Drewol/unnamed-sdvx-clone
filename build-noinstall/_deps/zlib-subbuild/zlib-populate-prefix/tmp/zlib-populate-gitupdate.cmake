...
execute_process(
  COMMAND "D:/Apps/Git/cmd/git.exe" --git-dir=.git show-ref "2.0.6"
  WORKING_DIRECTORY "D:/GitHub/unnamed-sdvx-clone/build-noinstall/_deps/zlib-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/GitHub/unnamed-sdvx-clone/build-noinstall/_deps/zlib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/GitHub/unnamed-sdvx-clone/build-noinstall/_deps/zlib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
